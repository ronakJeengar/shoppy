  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.wishlistAlerts, wishlistAlerts) ||
                other.wishlistAlerts == wishlistAlerts));
  }

  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, role, avatar,
      phone, orderUpdates, promotions, wishlistAlerts);

  @override
  String toString() {
    return 'UserEntity(id: $id, name: $name, email: $email, role: $role, avatar: $avatar, phone: $phone, orderUpdates: $orderUpdates, promotions: $promotions, wishlistAlerts: $wishlistAlerts)';
  }
}
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      wishlistAlerts: null == wishlistAlerts
          ? _self.wishlistAlerts
          : wishlistAlerts // ignore: cast_nullable_to_non_nullable
              as bool,
    ));
  }
}
