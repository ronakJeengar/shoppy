...
mixin _$UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, email: $email, role: $role, avatar: $avatar, phone: $phone, orderUpdates: $orderUpdates, promotions: $promotions, wishlistAlerts: $wishlistAlerts)';
  }
}
