...
/// theme responsiveness, and accessibility across the entire Shoppy application.
class AppIcon extends StatelessWidget {
  ...
  /// Semantic alias for small icons (16px)
  const AppIcon.small(
    this.assetPath, {
    super.key,
    this.color,
  ...
  /// Semantic alias for medium icons (20px)
  ...
  /// Semantic alias for large icons (24px)
  const AppIcon.large(
    this.assetPath, {
    super.key,
    this.color,
  ...
  /// Convenience constructor for navigation bar icons (24px)
  ...
  /// Convenience constructor for button icons (16px)
  ...
  Widget build(BuildContext context) {
    final effectiveSize = size ?? AppIconSizes.medium;
    ...
    return SvgPicture.asset(
      ...
      semanticsLabel: isDecorative ? null : semanticLabel,
